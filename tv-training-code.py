...
def main():
    ...
    dataset = PennFudanDataset('D://Robert//PennFudanPed', get_transform(train=True), True)
    dataset_test = PennFudanDataset('D://Robert//PennFudanPed', get_transform(train=False), False)
